...
export function accountsUpdateHelpText(): string {
  return [
    ...
    '',
    'Preview or update an owned account. Connected accounts support private Sloth names.',
    '',
    'Usage:',
    ...
    '  --account-name NAME                Name shown privately in Sloth.',
    '  --use-provider-name                 Clear a connected custom name and use the bank name.',
    ...
    '  Connected accounts support names, --goal-funding-account, and --partner-visibility.',
    '  Manual accounts require --account-name to be non-empty and do not support --use-provider-name.',
...
export function assignHelpText(): string {
  return [
    ...
    '  incomePeriodKey is optional (YYYY-MM) for Pay. It changes budget funding, not the bank date.',
    '  Omit it to keep a saved choice; new Pay defaults to its transaction period.',
    '  Past periods require saved budget context. Future Pay stays reserved until due.',
    '  A period change may create a shortfall in To assign. Interest is unchanged.',
