...
const files = ['transactions.ts', 'transactionRefresh.ts', 'transactionFixtures.ts', 'budgetFunding.ts', 'goalBudgets.ts', 'budgetCashflow.ts', 'budgetCashflowFixtures.ts', 'goals.ts', 'goalFixtures.ts'];
